...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.strategy_plugin = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.boundary.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.start_point.header.frame_id = str[start:end].decode('utf-8')
      else:
