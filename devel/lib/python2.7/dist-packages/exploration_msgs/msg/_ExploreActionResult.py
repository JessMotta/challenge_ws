...
"""autogenerated by genpy from exploration_msgs/ExploreActionResult.msg. Do not edit."""
import sys
...
class ExploreActionResult(genpy.Message):
  ...
  _type = "exploration_msgs/ExploreActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','exploration_msgs/ExploreResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = exploration_msgs.msg.ExploreResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = exploration_msgs.msg.ExploreResult()
